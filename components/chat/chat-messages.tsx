...
import type { ChatArtifact, ChatAttachment, ChatMessage, ChatMessageMetrics } from "../../lib/types";
import { CheckIcon, CopyIcon, EditIcon, RefreshIcon, ChevronDownIcon, FileIcon } from "./ui-icons";
import type { ProviderTheme } from "./providers";
import { splitByCodeBlocks, formatBytes, countLines } from "../../lib/utils";
...
function artifactSizeBytes(content: string) {
  try {
...
function buildArtifactClasses(isDark: boolean) {
  return {
    card: isDark
...
function AttachmentStrip({ attachments, isDark }: { attachments: ChatAttachment[]; isDark: boolean }) {
